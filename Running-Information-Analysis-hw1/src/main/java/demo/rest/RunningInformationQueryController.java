...
public class RunningInformationQueryController {
    ...
    @RequestMapping(value = "/purge", method = RequestMethod.DELETE)
    public void purgeId(String runningId) {
        runningInformationService.delete(String runningId);
    }
    ...
    @RequestMapping(value = "/healthLevel/{healthLevel}", method = RequestMethod.GET)
    public Page<RunningInformation> findAllRunningInformationOrderByHeathLevel(
            @PathVariable int healthWarningLevel,
            @RequestParam(name = "page", required = false, defaultValue = kDefaultPage) Integer page,
            @RequestParam(name = "size", required = false, defaultValue = kDefaultItemPerPage) Integer size) {

        return this.runningInformationService.findAllRunningInformationOrderByHeathLevel(healthWarningLevel, new PageRequest(page, size));
    }
